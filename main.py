...
if __name__ == "__main__":
    ...
    # no hard coding number of people
    ...
    trk_threshold = 100
    # output file path
    result_path = './deepsort/deepsort_result' + str(camera) + '.txt'
    ...
    print(count, "low confidence detections deleted")
    ...
    # Display all tracklets
    for trk in tracklets:
        print('Track', trk.ID, 'length:', len(trk.times))

    # Remove all tracklets with length less than the set threshold
    ...
    # write tracking result to txt file
